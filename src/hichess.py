...
from PySide2.QtWidgets import QWidget, QPushButton, QSplitter, QDockWidget, QVBoxLayout, QHBoxLayout
from PySide2.QtCore import Qt
from chessboard import ChessBoard

class HiChess(QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def setupGameScene(self):
        ...
        chessBoard = ChessBoard(side = ChessBoard.BoardSide.black)
